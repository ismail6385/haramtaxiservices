...
import type { BookingData } from '@/lib/supabase';
...
type ConfirmableBooking = BookingData & {
    id: string;
    customer_email: string;
    customer_name: string;
};

export async function sendBookingConfirmationEmail(booking: ConfirmableBooking) {
    if (!resend) {
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Dear <strong>${escapeHtml(booking.customer_name)}</strong>,</p>
                    ...
                    <div class="booking-details">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">${escapeHtml(booking.pickup_location)}</span>
                        </div>

                        <div class="detail-row">
                            <span class="label">Destination:</span>
                            <span class="value">${escapeHtml(booking.destination)}</span>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">${escapeHtml(booking.passengers || 1)} passengers</span>
                        </div>
