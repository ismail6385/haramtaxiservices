                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-4 mb-8">
                            {/* Address — NAP signal */}
                            <a href="https://maps.google.com/?q=Haram+Taxi+Service+Makkah+Saudi+Arabia" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white font-bold group-hover:text-brand-gold transition-colors"><span>Al Aziziyah</span>, <span>Makkah</span>, <span>Saudi Arabia</span></p>
                                </div>
                            </a>
                            {/* Phone / WhatsApp */}
                            <a href="https://wa.me/966575806733" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white font-bold group-hover:text-green-400 transition-colors">+966 57 580 6733</p>
                                </div>
                            </a>
                            {/* Email */}
                            <a href="mailto:booking@haramtaxiservice.com" className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white font-bold group-hover:text-brand-gold transition-colors">booking@haramtaxiservice.com</p>
                                </div>
                            </a>
                            {/* Hours */}
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white font-bold">Open 24 / 7 — All Days</p>
                                </div>
                            </div>
                            {/* Social sameAs */}
                            <div className="flex items-center gap-3 pt-2">
                                <a href="https://www.facebook.com/haramtaxiservice" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:border-blue-500 transition-colors">
                                    <Facebook className="w-4 h-4 text-gray-400 hover:text-blue-400" />
                                </a>
                                <a href="https://www.instagram.com/haramtaxiservice" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:border-pink-500 transition-colors">
                                    <Instagram className="w-4 h-4 text-gray-400 hover:text-pink-400" />
                                </a>
                                <a href="https://wa.me/966575806733" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:border-green-500 transition-colors">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                                <p className="text-xs font-bold text-gray-400 mb-2 leading-tight uppercase tracking-widest">Licensed & Insured</p>
                                <p className="text-xs text-gray-500 font-medium">Professionally licensed drivers and insured vehicles operating across all KSA regions and airports.</p>
                            </div>
                            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
