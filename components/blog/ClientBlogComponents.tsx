                ...
                <div className="flex gap-3 flex-wrap justify-center">
                    {buttons.map(({ href, icon: Icon, bg, hoverBg, label }) => (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`w-11 h-11 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 ${hoverBg} hover:text-white hover:border-transparent transition-all duration-200 shadow-sm hover:shadow-md`}
