...
export default function BorderCrossingTips({ borderName, targetCountry }: BorderCrossingTipsProps) {
    return (
        <div className="bg-brand-teal-pale/30 rounded-3xl p-8 border border-brand-teal/10 space-y-8 mt-12">
            <div className="flex items-center gap-4 mb-2">
                <div className="w-12 h-12 bg-brand-teal text-white rounded-2xl flex items-center justify-center font-bold">
                    <Info className="w-6 h-6" />
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-gray-900 border-b-2 border-brand-teal/20 pb-1">Efficient Border Crossing Guide</h3>
                    <p className="text-brand-teal font-medium mt-1">Travel Seamlessly Through {borderName}</p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                    <div className="flex items-start gap-4">
                        <div className="mt-1 bg-white p-2 rounded-xl shadow-sm border border-brand-teal/5 ring-4 ring-brand-teal/5">
                ...
                <div className="space-y-6">
                    <div className="flex items-start gap-4">
                        <div className="mt-1 bg-white p-2 rounded-xl shadow-sm border border-brand-teal/5 ring-4 ring-brand-teal/5">
                            <Car className="w-5 h-5 text-brand-teal" />
                        </div>
                        <div>
            ...
            <div className="pt-6 border-t border-brand-teal/10 flex items-center justify-between text-xs text-brand-teal-dark font-medium opacity-80 italic">
