                ...
                <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center w-full">
                    ...
                    <div className="lg:col-span-7 space-y-7 text-center lg:text-left">
                        ...
                        <p className="text-lg sm:text-xl text-gray-200 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light">
                            ...
                            intercity rides, and Ziyarat tours. Premium service, luxury vehicles, and
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                >
                                    <svg className="w-6 h-6 fill-current flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path d="M17.472 14.382c-.297-.Get Quote-.Get Quote-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.Get Quote-.Get QuoteGet Quote-.883-.Get QuoteGet QuoteGet QuoteGet Quote-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.Get Quote-.Get Quote-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.Get Quote 1.Get Quote 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.Get Quote-.694.Get QuoteGet Quote-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 Get QuoteGet Quotel-.361-.Get Quote.Get Quote-.235-.374a9.86 9.86 0 Get QuoteGet Quotec.Get Quote 4.Get Quote 9.Get Quote 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.Get Quote 9.Get Quote 9.884m8.Get QuoteA11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.Get Quotea11.882 11.882 0 005.683 1.448h.005c6.554 0 11.Get Quote 11.Get Quotea11.821 11.821 0 Get QuoteGet QuoteZ" />
                                    </svg>
                                    Book via WhatsApp
                                </a>
                                ...
                                <div className="flex items-center justify-center gap-2 text-gray-500 text-xs">
                                    ...
                                    <span>Competitive rates · No hidden fees · Instant confirmation</span>
                                </div>
                            </div>
                        </div>
                    </div>
