...
export default function BookingProcess() {
    ...
    return (
        <section className="py-24 bg-gray-50 overflow-hidden relative">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-brand-teal/20 to-transparent"></div>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-teal/10 text-brand-teal rounded-full text-xs font-bold uppercase tracking-widest mb-4">
                        Seamless Operations
                    </div>
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-gray-900 mb-6">How Your Journey <span className="text-brand-teal underline decoration-brand-amber underline-offset-8 italic">Unfolds</span></h2>
                ...
                <div className="grid md:grid-cols-3 gap-12 relative">
                    {/* Connecting line */}
                    <div className="hidden lg:block absolute top-12 left-0 w-full h-0.5 border-t-2 border-dashed border-brand-teal/20 -z-10"></div>
                    ...
                    {steps.map((step, i) => (
                        <div key={i} className="flex flex-col items-center text-center group">
                            <div className="w-24 h-24 bg-white rounded-3xl shadow-xl flex items-center justify-center mb-8 border border-gray-100 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 relative">
                                <span className="absolute -top-3 -right-3 w-8 h-8 bg-brand-amber text-white rounded-full flex items-center justify-center font-bold shadow-lg ring-4 ring-white">
                                    {i + 1}
                                </span>
                ...
                <div className="mt-20 p-10 bg-white rounded-[40px] border border-gray-100 shadow-2xl shadow-brand-teal/5 flex flex-col lg:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-6">
                        <div className="w-16 h-16 bg-brand-teal text-white rounded-2xl flex items-center justify-center flex-shrink-0 animate-pulse">
                    ...
                    <a 
                        href="https://wa.me/966569487569?text=Assalamu%20Alaikum%2C%20I%20am%20arriving%20soon%20and%20need%20a%20taxi."
                        target="_blank"
