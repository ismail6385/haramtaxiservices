    ...
    const faqs = [
        {
            ...
            answer: "King Abdullah Economic City is about 100km north of Jeddah Airport (JED), taking roughly a reasonable time by car."
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Kaec." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-teal-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        A taxi from KAEC to Jeddah Airport (JED) typically costs <span className="font-bold text-teal-700">Get Quote</span>.
                        Transfers from the Haramain Train Station to Bay La Sun or Marina start from <span className="font-bold text-teal-700">Get Quote</span>.
                        Rides to Rabigh city center are around <span className="font-bold text-teal-700">Get Quote</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Kaec." target="_blank" rel="noopener noreferrer" className="block w-full">
