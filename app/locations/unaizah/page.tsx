...
import { MapPin, Phone, Clock, Shield, Leaf, Truck, ArrowRight, Sun } from 'lucide-react';
    ...
    const faqs = [
        {
            ...
            answer: "The airport is conveniently located between Unaizah and Buraidah, about a 35-40 minute drive from Unaizah city center."
        },
        {
        ...
        <div className="bg-orange-50 min-h-screen">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Unaizah." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-orange-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxi Fares in Unaizah</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Local trips within Unaizah start at <span className="font-bold text-orange-700">15-20 SAR</span>.
                        Rides to Prince Naif Airport cost approximately <span className="font-bold text-orange-700">80-100 SAR</span>.
                        Intercity transfers to Buraidah are around <span className="font-bold text-orange-700">50-70 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Unaizah." target="_blank" rel="noopener noreferrer" className="block w-full">
