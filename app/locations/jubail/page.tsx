...
import { MapPin, Phone, Clock, Shield, Factory, CheckCircle2, Waves, ArrowRight } from 'lucide-react';
...
export default function JubailLocationPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Jubail is approximately 80-100km from King Fahd International Airport (DMM), taking about 45-60 minutes by car."
        },
        {
        ...
        },
        {
            ...
            answer: "A standard one-way trip between Jubail and Dammam typically costs between 150 SAR and 200 SAR."
        }
    ];
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Jubail." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-sky-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        A taxi from Jubail to Dammam Airport (DMM) typically costs <span className="font-bold text-sky-700">180-220 SAR</span>.
                        Local rides within the Royal Commission area start from <span className="font-bold text-sky-700">30 SAR</span>.
                        Transfers to Khobar or Dammam city are generally <span className="font-bold text-sky-700">200-250 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Jubail." target="_blank" rel="noopener noreferrer" className="block w-full">
