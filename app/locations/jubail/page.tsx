...
export default function JubailLocationPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Jubail is approximately 30km from King Fahd International Airport (DMM), taking about a reasonable time by car."
        },
        {
        ...
        },
        {
            ...
            answer: "A standard one-way trip between Jubail and Dammam typically costs between Get Quote and Get Quote"
        }
    ];
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Jubail." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Jubail." target="_blank" rel="noopener noreferrer" className="block w-full">
