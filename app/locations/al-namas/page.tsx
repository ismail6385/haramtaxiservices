...
import { MapPin, Phone, Clock, Shield, Globe, Cloud, ArrowRight } from 'lucide-react';
    ...
    const faqs = [
        {
            ...
            answer: "It is about 140-150 km north of Abha. The scenic drive takes around 2 hours."
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Namas." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-slate-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Transfers to Abha Airport are usually <span className="font-bold text-slate-700">250-300 SAR</span>.
                        Rides to Tanomah start from <span className="font-bold text-slate-700">50 SAR</span>.
                        Long-haul trips to Al Baha average <span className="font-bold text-slate-700">300-350 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Namas." target="_blank" rel="noopener noreferrer" className="block w-full">
