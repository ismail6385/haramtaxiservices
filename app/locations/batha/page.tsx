...
export default function BathaLocationPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Prices generally start from Get Quote for a private car due to the long distance and return trip logistics."
        }
    ];
        ...
        <div className="bg-purple-50 min-h-screen">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/966575806733?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Batha." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-purple-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">How much does a taxi to Batha Border cost?</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        From Riyadh, private taxi fares to Batha start around <span className="font-bold text-purple-700">Get Quote</span>.
                        Trips from Al Ahsa generally cost <span className="font-bold text-purple-700">Get Quote</span>.
                        Visa run waiting services usually add <span className="font-bold text-purple-700">Get Quote</span> per hour.
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-16">
                            ...
                            <BorderCrossingTips borderName="Batha" targetCountry="UAE" />
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/966575806733?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Batha." target="_blank" rel="noopener noreferrer" className="block w-full">
