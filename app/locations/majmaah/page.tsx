    ...
    const faqs = [
        {
            ...
            description: "Sudair Industrial City is located about 40-50km south of Majmaah, a 30-40 minute drive."
        },
        {
        ...
        },
        {
            ...
            answer: "A private transfer from Majmaah to King Khalid International Airport (RUH) typically ranges from 250 to 350 SAR."
        }
    ];
    // Correction: faqs array structure, first item used 'description' instead of 'answer'. Fixing below.
    faqs[0] = {
        question: "How far is Sudair Industrial City from Majmaah?",
        answer: "Sudair Industrial City is located about 40-50km south of Majmaah, a 30-40 minute drive."
    };
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Majmaah." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-emerald-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        A taxi from Majmaah SAR Station to the city center costs around <span className="font-bold text-emerald-700">30-40 SAR</span>.
                        Trips to Sudair Industrial City are typically <span className="font-bold text-emerald-700">60-80 SAR</span>.
                        Transfers to Riyadh Airport (RUH) start from <span className="font-bold text-emerald-700">250 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Majmaah." target="_blank" rel="noopener noreferrer" className="block w-full">
