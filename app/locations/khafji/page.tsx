...
import { MapPin, Phone, Clock, Shield, Anchor, Briefcase, ArrowRight } from 'lucide-react';
...
export default function KhafjiLocationPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "King Fahd International Airport (DMM) is about 270-300km south of Khafji, roughly a 3-hour drive."
        },
        {
        ...
        <div className="bg-indigo-50 min-h-screen">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Khafji." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-indigo-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxi Fares in Al Khafji</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        A local taxi ride in Khafji typically costs <span className="font-bold text-indigo-700">20-30 SAR</span>.
                        Transfers to the Kuwait Border post are around <span className="font-bold text-indigo-700">50-80 SAR</span>.
                        Long distance to Dammam Airport starts from <span className="font-bold text-indigo-700">350-400 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Khafji." target="_blank" rel="noopener noreferrer" className="block w-full">
