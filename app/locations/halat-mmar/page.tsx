...
import { MapPin, Phone, Clock, Shield, Globe, Send, User, ArrowRight } from 'lucide-react';
        ...
        <div className="bg-orange-50 min-h-screen">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Halat%20Mmar." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-orange-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxi Fares from Halat Ammar</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Transfers to Tabuk city center are approximately <span className="font-bold text-orange-700">150-200 SAR</span>.
                        Rides to Duba port cost around <span className="font-bold text-orange-700">300-350 SAR</span>.
                        Long-distance trips to Medina for pilgrims vary by vehicle, starting from <span className="font-bold text-orange-700">800 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Halat%20Mmar." target="_blank" rel="noopener noreferrer" className="block w-full">
