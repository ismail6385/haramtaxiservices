...
import { MapPin, Phone, Clock, Shield, Waves, Building2, ArrowRight } from 'lucide-react';
...
export default function KhobarLocationPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "A one-way trip from Al Khobar to Manama (Bahrain) typically costs between 250 SAR and 350 SAR, including plain causeway fees."
        },
        {
            question: "How far is Dammam Airport from Al Khobar?",
            answer: "King Fahd International Airport (DMM) is about 50-60km from Al Khobar, a 40-45 minute drive."
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Khobar." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-cyan-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        A taxi from Al Khobar to Dammam Airport (DMM) typically costs <span className="font-bold text-cyan-700">100-140 SAR</span>.
                        A trip to Bahrain (Manama) usually ranges from <span className="font-bold text-cyan-700">250-350 SAR</span> depending on traffic.
                        Local city rides start from <span className="font-bold text-cyan-700">20-30 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Khobar." target="_blank" rel="noopener noreferrer" className="block w-full">
