    ...
    const faqs = [
        {
            ...
            answer: "It is about a short distance away. The drive typically takes a estimated time."
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/996575806733?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Rass." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-16">
                            ...
                            {/* Services List */}
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-8">Al-rass Taxi Services</h2>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/996575806733?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Rass." target="_blank" rel="noopener noreferrer" className="block w-full">
