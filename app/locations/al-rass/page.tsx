...
import { MapPin, Phone, Clock, Shield, Globe, Star, ArrowRight, MessageCircle } from 'lucide-react';
    ...
    const faqs = [
        {
            ...
            answer: "It is about a short distance away. The drive typically takes a reasonable time."
        },
        {
            question: "How much is a taxi to Medina?",
            answer: "A private sedan to Medina (approx. 400km) usually starts from Get Quote"
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Rass." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-emerald-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Rides to Buraidah city center are typically <span className="font-bold text-emerald-700">Get Quote</span>.
                        Local trips within Al Rass start from <span className="font-bold text-emerald-700">Get Quote</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/966569487569?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Al%20Rass." target="_blank" rel="noopener noreferrer" className="block w-full">
