...
import { MapPin, Phone, Clock, Shield, Globe, ShoppingBag, ArrowRight } from 'lucide-react';
    ...
    const faqs = [
        {
            ...
            answer: "Qatif is very close to King Fahd Airport (approx. 30-40km). The trip usually takes 25-30 minutes."
        },
        {
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-wrap gap-4">
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Qatif." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-teal-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Rides to Dammam Airport typically cost <span className="font-bold text-teal-700">80-100 SAR</span>.
                        Transfers to Jubail Industrial City range from <span className="font-bold text-teal-700">120-150 SAR</span>.
                        Local trips within Qatif/Saihat start from <span className="font-bold text-teal-700">15-20 SAR</span>.
                    </p>
                </div>
            </section>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                ...
                                <div className="p-6">
                                    ...
                                    <a href="https://wa.me/923080628195?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Qatif." target="_blank" rel="noopener noreferrer" className="block w-full">
